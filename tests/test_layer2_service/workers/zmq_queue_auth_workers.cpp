...
// `legacy_unauth_factories_unchanged` scenario deleted in #160 (C4):
// the legacy plaintext `pull_from`/`push_to` factories no longer
// exist; every ZmqQueue is CURVE-wired (HEP-CORE-0035 §2 +
// HEP-CORE-0040 §8.4).
