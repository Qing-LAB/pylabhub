...
typedef void (*plh_allowed_peer_visitor)(const plh_allowed_peer_t *peer, void *userdata);
...
typedef void (*plh_role_uid_visitor)(const char *role_uid, void *userdata);
...
typedef void (*plh_band_member_visitor)(const plh_band_member_t *member, void *userdata);
