...
struct RoleAPIBase::Impl
{
    ...
    // Role-side CurveZMQ keypair (Wave-B M4a) — used by RoleHandler to
    // populate BrokerRequestComm::Config at start() time.  Empty =
    // plaintext (no CURVE).  Set-once before RoleHandler::start().
