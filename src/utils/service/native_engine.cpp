...
void ctx_log(const PlhNativeContext *ctx, int level, const char *msg)
{
    ...
    {
    case PLH_LOG_DEBUG:
        LOGGER_DEBUG("{} {}", label, msg);
        break;
    case PLH_LOG_WARN:
        LOGGER_WARN("{} {}", label, msg);
        break;
    case PLH_LOG_ERROR:
        LOGGER_ERROR("{} {}", label, msg);
        break;
    case PLH_LOG_INFO: // fallthrough
    default:
        LOGGER_INFO("{} {}", label, msg);
        break;
    }
}
...
template <typename Fn> const char *hub_json_invoke(const PlhNativeContext *ctx, Fn &&fn) noexcept
{
...
{
    return hub_json_invoke(ctx, [](hub_host::HubAPI &api) { return api.metrics(); });
}

const char *ctx_hub_config_json(const PlhNativeContext *ctx)
{
    return hub_json_invoke(ctx, [](hub_host::HubAPI &api) { return api.config(); });
}

const char *ctx_hub_query_metrics_json(const PlhNativeContext *ctx, const char *categories_json)
{
                           ...
                           [categories_json](hub_host::HubAPI &api)
                           {
                               ...
                               if (categories_json && *categories_json)
                               {
                                   ...
                                   if (j.is_array())
                                       for (const auto &e : j)
                                           if (e.is_string())
                                               cats.push_back(e.get<std::string>());
                               }
...
{
    return hub_json_invoke(ctx, [](hub_host::HubAPI &api) { return api.list_channels(); });
}

const char *ctx_hub_get_channel_json(const PlhNativeContext *ctx, const char *name)
{
    if (!name)
        return nullptr;
    return hub_json_invoke(ctx, [name](hub_host::HubAPI &api) { return api.get_channel(name); });
}

const char *ctx_hub_list_roles_json(const PlhNativeContext *ctx)
{
    return hub_json_invoke(ctx, [](hub_host::HubAPI &api) { return api.list_roles(); });
}

const char *ctx_hub_get_role_json(const PlhNativeContext *ctx, const char *role_uid)
{
    if (!role_uid)
        return nullptr;
    return hub_json_invoke(ctx,
...
{
    return hub_json_invoke(ctx, [](hub_host::HubAPI &api) { return api.list_bands(); });
}

const char *ctx_hub_get_band_json(const PlhNativeContext *ctx, const char *name)
{
    if (!name)
        return nullptr;
    return hub_json_invoke(ctx, [name](hub_host::HubAPI &api) { return api.get_band(name); });
}

const char *ctx_hub_list_peers_json(const PlhNativeContext *ctx)
{
    return hub_json_invoke(ctx, [](hub_host::HubAPI &api) { return api.list_peers(); });
}

const char *ctx_hub_get_peer_json(const PlhNativeContext *ctx, const char *hub_uid)
{
    if (!hub_uid)
        return nullptr;
    return hub_json_invoke(ctx, [hub_uid](hub_host::HubAPI &api) { return api.get_peer(hub_uid); });
}
...
int ctx_hub_broadcast_channel(const PlhNativeContext *ctx, const char *channel, const char *message,
                              const char *data_json)
{
    ...
    try
    {
        static_cast<hub_host::HubAPI *>(ctx->_api)->broadcast_channel(channel, message,
                                                                      data_json ? data_json : "");
        return 1;
    }
    catch (...)
...
void ctx_hub_set_augment_timeout(const PlhNativeContext *ctx, int64_t ms)
{
    ...
    { /* defensive: nothing observable to do */
    }
}
...
int hub_stub_is_critical_error(const PlhNativeContext *) noexcept
{
    return 0;
}
int hub_stub_stop_reason(const PlhNativeContext *) noexcept
{
    return PLH_STOP_REASON_NORMAL;
}
uint64_t hub_stub_counter_zero(const PlhNativeContext *) noexcept
{
    return 0;
}
int hub_stub_spinlock_lock(const PlhNativeContext *, int, int, int) noexcept
{
    return 0;
}
void hub_stub_spinlock_unlock(const PlhNativeContext *, int, int) noexcept {}
uint32_t hub_stub_spinlock_count(const PlhNativeContext *, int) noexcept
{
    return 0;
}
int hub_stub_spinlock_is_locked(const PlhNativeContext *, int, int) noexcept
{
    return 0;
}
size_t hub_stub_size_arg2_zero(const PlhNativeContext *, int) noexcept
{
    return 0;
}
int hub_stub_wait_for_role(const PlhNativeContext *, const char *, int) noexcept
{
    return 0;
}
...
int hub_stub_inbox_send(const PlhNativeContext *, void *, int) noexcept
{
    return -1;
}
...
int hub_stub_band_member_contains(const PlhNativeContext *, const char *, const char *) noexcept
{
    return -1;
}
int hub_stub_allowed_peers(const PlhNativeContext *, const char *, plh_allowed_peer_visitor,
                           void *) noexcept
{
    return -1;
}
int hub_stub_role_uid_visit(const PlhNativeContext *, const char *, plh_role_uid_visitor,
                            void *) noexcept
{
    return -1;
}
int hub_stub_allowed_peer_contains(const PlhNativeContext *, const char *, const char *) noexcept
{
    return -1;
}
int hub_stub_is_channel_ready(const PlhNativeContext *, const char *) noexcept
{
    return -1;
}
int hub_stub_queue_mechanism(const PlhNativeContext *, int) noexcept
{
    return PLH_MECHANISM_UNINITIALIZED;
}
int hub_stub_queue_policy(const PlhNativeContext *) noexcept
{
    return PLH_QUEUE_POLICY_UNKNOWN;
}
const void *hub_stub_metrics_snapshot(const PlhNativeContext *) noexcept
{
    return nullptr;
}
int hub_stub_metrics_get(const void *, const char *, double *) noexcept
{
    return -1;
}
int hub_stub_is_in_band(const PlhNativeContext *, const char *) noexcept
{
    return -1;
}
int hub_stub_update_flexzone_checksum(const PlhNativeContext *) noexcept
{
    return 0;
}
...
extern "C"
{
    const char *role_stub_hub_json_no_arg(const PlhNativeContext *) noexcept
    {
        return "";
    }
    const char *role_stub_hub_json_query(const PlhNativeContext *, const char *) noexcept
    {
        return "";
    }
    const char *role_stub_hub_json_query_arg(const PlhNativeContext *, const char *) noexcept
    {
        return "";
    }
    int role_stub_hub_close_channel(const PlhNativeContext *, const char *) noexcept
    {
        return -1;
    }
    ...
    int role_stub_hub_post_event(const PlhNativeContext *, const char *, const char *) noexcept
    {
        return -1;
    }
    int64_t role_stub_hub_augment_timeout_ms(const PlhNativeContext *) noexcept
    {
        return 0;
    }
...
void ctx_set_critical_error(const PlhNativeContext *ctx, const char *msg)
{
    ...
    const std::string_view sv =
        msg ? std::string_view{msg} : std::string_view{"(no message — C plugin passed NULL; bug)"};
    if (ctx->_api)
    {
...
int ctx_stop_reason(const PlhNativeContext *ctx)
{
    ...
    if (!ctx || !ctx->_core)
        return PLH_STOP_REASON_NORMAL;
    return static_cast<int>(static_cast<RoleHostCore *>(ctx->_core)->stop_reason());
}
...
void ctx_spinlock_unlock(const PlhNativeContext *ctx, int index, int side)
{
    ...
    catch (const std::exception &e)
    {
        ...
        LOGGER_WARN("native_engine: ctx_spinlock_unlock(idx={}) threw: {}", index, e.what());
    }
    catch (...)
    {
...
uint32_t ctx_spinlock_count(const PlhNativeContext *ctx, int side)
{
    ...
    try
    {
        return api->spinlock_count(side_from_int(side));
    }
    catch (...)
    {
        return 0;
...
size_t ctx_slot_logical_size(const PlhNativeContext *ctx, int side)
{
    ...
    try
    {
        return api->slot_logical_size(side_from_int(side));
    }
    catch (...)
    {
        return 0;
...
size_t ctx_flexzone_logical_size(const PlhNativeContext *ctx, int side)
{
    ...
    try
    {
        return api->flexzone_logical_size(side_from_int(side));
    }
    catch (...)
    {
        return 0;
...
int ctx_inbox_send(const PlhNativeContext * /*ctx*/, void *handle, int timeout_ms)
{
    ...
    return static_cast<int>(
        static_cast<hub::InboxClient *>(handle)->send(std::chrono::milliseconds{timeout_ms}));
}

void ctx_inbox_discard(const PlhNativeContext * /*ctx*/, void *handle)
{
    if (handle)
        static_cast<hub::InboxClient *>(handle)->abort();
}
...
int policy_string_to_macro(const std::string &s) noexcept
{
    ...
    if (s.empty())
        return PLH_QUEUE_POLICY_UNKNOWN;
    if (s == "shm_read" || s == "shm_write")
        return PLH_QUEUE_POLICY_SHM;
    if (s == "zmq_push_drop")
        return PLH_QUEUE_POLICY_ZMQ_DROP;
    if (s == "zmq_push_block")
        return PLH_QUEUE_POLICY_ZMQ_BLOCK;
    // "zmq_pull_ring_N" — the depth tail is variable per queue.
    if (s.rfind("zmq_pull_ring", 0) == 0)
        return PLH_QUEUE_POLICY_ZMQ_RING;
...
std::optional<nlohmann::json> fetch_band_members(const PlhNativeContext *ctx,
...
{
    if (!ctx || !ctx->_api || !channel || !body_json)
        return;
    try
    {
...
int ctx_band_members(const PlhNativeContext *ctx, const char *channel,
                     plh_band_member_visitor visitor, void *userdata)
{
    ...
    if (!ctx || !ctx->_api || !channel || !visitor)
        return -1;
    ...
    catch (...)
    {
        LOGGER_ERROR("native_engine: ctx_band_members('{}') visitor "
                     "threw across C ABI; aborting iteration",
                     channel);
        return -1;
    }
}

int ctx_band_member_contains(const PlhNativeContext *ctx, const char *channel, const char *role_uid)
{
...
int ctx_allowed_peers(const PlhNativeContext *ctx, const char *channel,
...
int ctx_allowed_peer_contains(const PlhNativeContext *ctx, const char *channel,
                              const char *role_uid)
{
    if (!ctx || !ctx->_api || !channel || !role_uid)
        return -1;
...
int ctx_is_channel_ready(const PlhNativeContext *ctx, const char *channel)
{
    ...
    try
    {
        return static_cast<RoleAPIBase *>(ctx->_api)->is_channel_ready(channel) ? 1 : 0;
    }
    catch (...)
    {
        return -1;
...
int ctx_consumer_count(const PlhNativeContext *ctx, const char *channel)
{
    ...
    try
    {
        return static_cast<int>(static_cast<RoleAPIBase *>(ctx->_api)->consumer_count(channel));
    }
    catch (...)
    {
        return -1;
...
int ctx_producer_count(const PlhNativeContext *ctx, const char *channel)
{
    ...
    try
    {
        return static_cast<int>(static_cast<RoleAPIBase *>(ctx->_api)->producer_count(channel));
    }
    catch (...)
    {
        return -1;
...
int ctx_producers(const PlhNativeContext *ctx, const char *channel, plh_role_uid_visitor visitor,
                  void *userdata)
{
    if (!ctx || !ctx->_api || !channel || !visitor)
        return -1;
    try
    {
        const auto uids = static_cast<RoleAPIBase *>(ctx->_api)->producers(channel);
    ...
    {
        LOGGER_ERROR("native_engine: ctx_producers('{}') threw: {}", channel, e.what());
        return -1;
    }
    catch (...)
    {
...
int ctx_consumers(const PlhNativeContext *ctx, const char *channel, plh_role_uid_visitor visitor,
                  void *userdata)
{
    if (!ctx || !ctx->_api || !channel || !visitor)
        return -1;
    try
    {
        const auto uids = static_cast<RoleAPIBase *>(ctx->_api)->consumers(channel);
        for (const auto &u : uids)
            visitor(u.c_str(), userdata);
        return static_cast<int>(uids.size());
    }
    ...
    {
        LOGGER_ERROR("native_engine: ctx_consumers('{}') threw: {}", channel, e.what());
        return -1;
    }
    catch (...)
    {
...
int ctx_queue_mechanism(const PlhNativeContext *ctx, int side)
{
    ...
    if (!ctx || !ctx->_api)
        return PLH_MECHANISM_UNINITIALIZED;
    const ChannelSide cs = (side == PLH_SIDE_TX) ? ChannelSide::Tx : ChannelSide::Rx;
    try
    {
        return static_cast<int>(static_cast<RoleAPIBase *>(ctx->_api)->queue_mechanism(cs));
    }
    catch (...)
    {
        return PLH_MECHANISM_UNINITIALIZED;
...
uint64_t ctx_out_capacity(const PlhNativeContext *ctx)
{
    ...
    try
    {
        return static_cast<uint64_t>(static_cast<RoleAPIBase *>(ctx->_api)->out_capacity());
    }
    catch (...)
    {
        return 0;
...
uint64_t ctx_in_capacity(const PlhNativeContext *ctx)
{
    ...
    try
    {
        return static_cast<uint64_t>(static_cast<RoleAPIBase *>(ctx->_api)->in_capacity());
    }
    catch (...)
    {
        return 0;
...
int ctx_out_policy(const PlhNativeContext *ctx)
{
    ...
    try
    {
        return policy_string_to_macro(static_cast<RoleAPIBase *>(ctx->_api)->out_policy());
    }
    catch (...)
    {
        return PLH_QUEUE_POLICY_UNKNOWN;
...
int ctx_in_policy(const PlhNativeContext *ctx)
{
    ...
    try
    {
        return policy_string_to_macro(static_cast<RoleAPIBase *>(ctx->_api)->in_policy());
    }
    catch (...)
    {
        return PLH_QUEUE_POLICY_UNKNOWN;
...
void flatten_json_into(const nlohmann::json &node, const std::string &prefix,
...
const void *ctx_metrics_snapshot(const PlhNativeContext *ctx)
{
    ...
    {
        cache.clear();
        const auto j = static_cast<RoleAPIBase *>(ctx->_api)->snapshot_metrics_json();
...
int ctx_metrics_get(const void *snapshot, const char *key, double *out)
{
    ...
    try
    {
        const auto *cache = static_cast<const std::unordered_map<std::string, double> *>(snapshot);
...
int ctx_update_flexzone_checksum(const PlhNativeContext *ctx)
{
    ...
    try
    {
        return static_cast<RoleAPIBase *>(ctx->_api)->update_flexzone_checksum() ? 1 : 0;
    }
    catch (...)
    {
        return 0;
                               ...
                               const std::string &entry_point, const std::string &required_callback)
{
    ...
    if (!std::filesystem::exists(lib_path_))
    {
        ...
        if (!std::filesystem::exists(lib_path_))
        {
            LOGGER_ERROR("[{}] native engine not found: {} (also tried: {})", log_tag_,
                         lib_path_.string(), (script_dir / entry_point).string());
            return false;
        }
    }
    ...
    {
        LOGGER_ERROR(
            "[{}] native engine missing required symbols: native_init and/or native_finalize",
            log_tag_);
        DL_CLOSE(dl_handle_);
        dl_handle_ = nullptr;
        return false;
    ...
    {
        LOGGER_ERROR("[{}] native engine missing required callback: {}", log_tag_,
                     required_callback);
        DL_CLOSE(dl_handle_);
        dl_handle_ = nullptr;
        return false;
    ...
    LOGGER_INFO("[{}] native engine loaded: {} v{} from {}", log_tag_,
                fn_name ? fn_name() : "(unnamed)", fn_ver ? fn_ver() : "?", lib_path_.string());
...
bool NativeEngine::build_api_(RoleAPIBase &api)
{
    ...
    lifecycle_module_name_ = "NativeEngine:" + lib_path_.filename().string();
    {
        ...
        mod.set_shutdown([](const char *, void *) {}, std::chrono::milliseconds{5000});
        if (pylabhub::utils::RegisterDynamicModule(std::move(mod)))
        {
            ...
            // 2026-06-11.
            lifecycle_registered_ = pylabhub::utils::LoadModule(lifecycle_module_name_.c_str());
            if (!lifecycle_registered_)
                ...
                LOGGER_DEBUG("[{}] lifecycle module registered: {}", log_tag_,
                             lifecycle_module_name_);
        }
    }
...
bool NativeEngine::build_api_(hub_host::HubAPI &api)
{
    ...
    if (!fn_init_(&native_ctx_->ctx))
    {
        LOGGER_ERROR("[{}] native_init returned false (hub-side build_api)", log_tag_);
        return false;
    }
    ...
    lifecycle_module_name_ = "NativeEngine:" + lib_path_.filename().string();
    {
        ...
        if (pylabhub::utils::RegisterDynamicModule(std::move(mod)))
        {
            ...
            if (!lifecycle_registered_)
                ...
                LOGGER_DEBUG("[{}] lifecycle module registered (hub): {}", log_tag_,
                             lifecycle_module_name_);
        }
    }
...
void NativeEngine::finalize_engine_()
{
    ...
    if (lifecycle_registered_)
    {
        if (!pylabhub::utils::UnloadModule(lifecycle_module_name_.c_str()))
            LOGGER_WARN("[{}] lifecycle UnloadModule({}) returned false", log_tag_,
                        lifecycle_module_name_);
...
{
    if (name == "on_init")
        return fn_on_init_ != nullptr;
    if (name == "on_stop")
        return fn_on_stop_ != nullptr;
    ...
    if (name == "on_band_member_joined")
        return fn_on_band_member_joined_ != nullptr;
    ...
    if (name == "on_allowlist_changed")
        return fn_on_allowlist_changed_ != nullptr;
    if (name == "on_produce")
        return fn_on_produce_ != nullptr;
    if (name == "on_consume")
        return fn_on_consume_ != nullptr;
    if (name == "on_process")
        return fn_on_process_ != nullptr;
    if (name == "on_inbox")
        return fn_on_inbox_ != nullptr;
    if (name == "on_heartbeat")
        return fn_on_heartbeat_ != nullptr;
...
bool NativeEngine::register_slot_type(const hub::SchemaSpec &spec, const std::string &type_name,
                                      const std::string &packing)
{
    ...
    if (fn_schema)
    {
        ...
        {
            LOGGER_ERROR("[{}] schema mismatch for {}: config='{}', native engine='{}'", log_tag_,
                         type_name, expected_schema, native_schema);
            return false;
        }
    }
    else
    ...
    if (!fn_sz)
    {
        LOGGER_ERROR("[{}] native engine must export '{}' for type '{}'", log_tag_, sym_sizeof,
                     type_name);
        return false;
    }
...
pylabhub::scripting::ScriptEngine::InitStatus NativeEngine::invoke_on_init()
{
...
void NativeEngine::invoke_on_channel_closing(const std::string &channel, const std::string &reason)
{
    if (!fn_on_channel_closing_)
        return;
...
{
    if (!fn_on_band_member_joined_)
        return;
    const plh_band_member_joined_args_t args{band.c_str(), role_uid.c_str(), role_name.c_str()};
    fn_on_band_member_joined_(&args);
}

void NativeEngine::invoke_on_band_member_left(const std::string &band, const std::string &role_uid,
                                              const std::string &reason)
{
    if (!fn_on_band_member_left_)
        return;
    const plh_band_member_left_args_t args{band.c_str(), role_uid.c_str(), reason.c_str()};
...
void NativeEngine::invoke_on_allowlist_changed(const std::string &channel,
                                               const std::vector<AllowedPeer> &allowlist,
                                               const std::string &reason)
{
    if (!fn_on_allowlist_changed_)
        return;
    ...
    for (const auto &p : allowlist)
        peers_c.push_back(plh_allowed_peer_t{p.role_uid.c_str(), p.pubkey.c_str()});

    const plh_allowlist_changed_args_t args{channel.c_str(),
                                            peers_c.empty() ? nullptr : peers_c.data(),
                                            peers_c.size(), reason.c_str()};
    fn_on_allowlist_changed_(&args);
}

InvokeResult NativeEngine::invoke_produce(InvokeTx tx, std::vector<IncomingMessage> & /*msgs*/)
{
...
InvokeResult NativeEngine::invoke_consume(InvokeRx rx, std::vector<IncomingMessage> & /*msgs*/)
{
    if (!fn_on_consume_)
    {
        if (is_accepting())
...
InvokeResult NativeEngine::invoke_process(InvokeRx rx, InvokeTx tx,
...
InvokeResult NativeEngine::invoke_on_inbox(InvokeInbox msg)
{
    if (!fn_on_inbox_)
    {
        if (is_accepting())
...
{
    auto fn = reinterpret_cast<const PlhAbiInfo *(*)()>(resolve_sym_("native_abi_info"));

    if (!fn)
    {
        LOGGER_WARN("[{}] native engine does not export native_abi_info — skipping ABI check",
                    log_tag_);
    ...
    {
        LOGGER_ERROR("[{}] native engine ABI struct too small ({} < {})", log_tag_,
                     info->struct_size, sizeof(PlhAbiInfo));
        return false;
    }
    ...
    {
        LOGGER_ERROR("[{}] pointer size mismatch: native engine={}, host={}", log_tag_,
                     info->sizeof_void_ptr, static_cast<uint32_t>(sizeof(void *)));
        return false;
    }

    if (info->sizeof_size_t != sizeof(size_t))
    {
        LOGGER_ERROR("[{}] size_t mismatch: native engine={}, host={}", log_tag_,
                     info->sizeof_size_t, static_cast<uint32_t>(sizeof(size_t)));
        return false;
    }
    ...
    {
        LOGGER_ERROR("[{}] byte order mismatch: native engine={}, host={}", log_tag_,
                     info->byte_order, host_byte_order);
        return false;
    }
    ...
    {
        LOGGER_ERROR("[{}] API version mismatch: native engine={}, host={}", log_tag_,
                     info->api_version, PLH_NATIVE_API_VERSION);
        return false;
    }
    ...
    if (info->struct_size >= kAbiInfoV3Size)
    {
        ...
        auto warn_if_diff = [this](const char *name, unsigned plugin_v, unsigned host_v)
        {
            if (plugin_v != host_v)
        ...
        {
            if (std::strncmp(info->build_id, host_bid, sizeof(info->build_id)) != 0)
            {
...
bool NativeEngine::verify_file_checksum_() const
{
    ...
    if (!file)
    {
        LOGGER_ERROR("[{}] cannot open native engine file for checksum: {}", log_tag_,
                     lib_path_.string());
        return false;
    }
    ...
    {
        LOGGER_ERROR("[{}] native engine checksum mismatch: expected={}, actual={}", log_tag_,
                     expected_checksum_, hex);
        return false;
    }
