...
| **Status** | 🟢 **DESIGN FINAL; PHASE 1 IN FLIGHT** — substeps 1a-1h ✅; 1i-mig-1/2a/2b-1/2b-2/2c/M3/3 ✅ (TX side complete on both producer + processor); 1i-mig-M3.5/doc-sync/prod-hardening/api-scope (#266-#269) ⏸; 1i-mig-4 (consumer dial) ⏸; 1i-mig-5 + 1i-cleanup + 1j + 1k + #262 ⏸.  Five REVIEW-A..E milestones gate the remaining chain.  Live tracker at §10.1. |
| **Created** | 2026-06-16 |
...
|  | | ⏸ | **REVIEW-A — milestone A.**  Full systematic review (parallel agents: doc-vs-code + dead-code + gaps + edge-case) after #266+#267+#268+#269 land.  Confirms the cleanup chain is consistent before consumer-dial starts.  |
