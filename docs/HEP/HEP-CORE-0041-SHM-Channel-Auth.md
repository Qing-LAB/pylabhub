...
| 1k | #258 | ⏸ | L4 end-to-end SHM auth-gated data flow — **MUST also embed the L2 contract verifications folded in from #270** (transport bind / accept-loop spawn / LIFO teardown / no thread leak via production marker grepping).  Full marker checklist with source lines in #258 task description. |
