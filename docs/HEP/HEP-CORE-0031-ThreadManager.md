...
| (draft, 2026-06-23) | — | **Amendment in draft (#283):** §4.4 "Bounded-Deadline Threads" — adds `spawn_bounded` primitive for bounded-deadline work (consumer SHM dial in #272 surfaced the pattern; recurs in producer L2c, future #262, #75, #247).  Step-function body contract + single sweeper thread + state machine with one-shot abnormality detection.  Tech draft at `docs/tech_draft/DRAFT_HEP-0031-bounded-thread_2026-06.md`. |
