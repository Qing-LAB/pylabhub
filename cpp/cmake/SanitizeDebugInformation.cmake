...
message(VERBOSE "[Sanitize debug information] canonical CMAKE_SOURCE_DIR = ${_canon_source}")
message(VERBOSE "[Sanitize debug information] canonical CMAKE_BINARY_DIR = ${_canon_binary}")
...
if(CMAKE_CXX_COMPILER)
  ...
  if(_cxx_root AND NOT "${_cxx_root}" STREQUAL "")
    ...
    if(_p)
      ...
      message(VERBOSE "[Sanitize debug information] canonical TOOLCHAIN = ${_p}")
    endif()
  endif()
endif()
...
if(DEFINED CMAKE_SYSROOT AND NOT "${CMAKE_SYSROOT}" STREQUAL "")
  ...
  if(_p)
    ...
    message(VERBOSE "[Sanitize debug information] canonical SYSROOT = ${_p}")
  endif()
endif()
...
if(DEFINED ENV{CONDA_PREFIX} AND NOT "$ENV{CONDA_PREFIX}" STREQUAL "")
  ...
  if(_p)
    ...
    message(VERBOSE "[Sanitize debug information] canonical CONDA = ${_p}")
  endif()
endif()
...
if(DEFINED ENV{VCToolsInstallDir} AND NOT "$ENV{VCToolsInstallDir}" STREQUAL "")
  ...
  if(_p)
    ...
    message(VERBOSE "[Sanitize debug information] canonical VCTOOLS = ${_p}")
  endif()
endif()
...
if(_remap_flags)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang")
    ...
    message(VERBOSE "[Sanitized debug information] Will pass file/debug prefix map flags:")
  ...
  message(VERBOSE "[Sanitized debug information] No remap flags generated.")
endif()
