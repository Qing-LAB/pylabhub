...
if(EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/fmt/CMakeLists.txt")
  ...
  foreach(_cand IN LISTS _fmt_candidates)
    if(TARGET "${_cand}" AND NOT TARGET "${_cand}" STREQUAL "INTERFACE")
      _pylabhub_resolve_alias_to_concrete("${_cand}" _fmt_canonical_target)
  ...
  message(FATAL_ERROR "[pylabhub-third-party] fmt submodule not found at ${CMAKE_CURRENT_SOURCE_DIR}/fmt. Skipping configuration.")
endif()
