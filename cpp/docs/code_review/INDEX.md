...
|----|------|--------|--------------|
| P7 | Layer 2 Transaction API | 2-3 days | Exception safety (resource leaks without) |
| P8 | Error Recovery API | 2 days | Production debugging (stuck slots) |
...
**Next:** Update HEP-core-0002, complete P7-P9 design
