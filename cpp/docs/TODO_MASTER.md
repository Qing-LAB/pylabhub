...
|------|--------|----------------|-------|
| Security / Identity / Provenance | ✅ Complete | `docs/todo/SECURITY_TODO.md` | All phases complete (2026-02-27): connection policy enforcement, SHM identity, HubConfig single-file load, stable vault keypair, actor --register-with, legacy flat-config removed. 550/550 tests. |
...
| Testing | 🟢 Ongoing | `docs/todo/TESTING_TODO.md` | **573/573 passing** (10 new ScriptHost threading unit tests in test_layer2_script_host; 9 new HubConfig script-block tests in test_layer3_datahub); Coverage gaps: ContextMetrics DataBlock Pimpl tests (LoopPolicy timing domain); Layer 4 actor integration tests (live broker + actor); Layer 3 embedded-mode integration tests |
...
**Active code reviews:** None. (Both 2026-02-27 reviews archived to `docs/archive/transient-2026-02-27/`; logged in `docs/DOC_ARCHIVE_LOG.md`.)
