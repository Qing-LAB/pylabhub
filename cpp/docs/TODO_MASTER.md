...
| Testing | 🟢 Ongoing | `docs/todo/TESTING_TODO.md` | 539/539 passing (82 Layer 4 unit tests: 72 config/metrics + 10 embedded-mode; 5 DatahubLoopPolicy tests; 11 new Phase 3 connection policy tests, 2026-02-26); Layer 3 embedded-mode integration tests pending (require live broker + actor) |
