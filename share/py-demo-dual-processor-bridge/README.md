# py-demo-dual-processor-bridge — Dual-Hub Bridge Demo

Demonstrates **cross-hub data flow** using mixed SHM + ZMQ transport.
Unlike `py-demo-single-processor-shm` (pure SHM, single hub), this demo
uses **two hubs** connected by a ZMQ bridge between two processors, with
SHM on the local segments and ZMQ for the inter-hub link.
...
# Run the demo
bash share/py-demo-dual-processor-bridge/run_demo.sh
